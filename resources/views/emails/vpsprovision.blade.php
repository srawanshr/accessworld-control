...
@section('content')
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        <td class="content-block aligncenter"
            ...
            valign="top">
            <table class="invoice"
                   style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; text-align: left; width: 80%; margin: 0 auto 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;"
                        valign="top">
                        <h2 class="aligncenter"
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif; box-sizing: border-box; font-size: 18px; color: #000; line-height: 1.2em; font-weight: 400; text-align: center; margin: 20px 0 20px;"
                            align="center">
                ...
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;">
                        ...
                        <p style="text-align: center;">
                            <em style="margin: 0;">
                                Please be noted that unless you change your SSH key from your AccessWorld Customer
                                Panel, you CANNOT access your VPS.
                                <a href="https://www.accessworld.net/login" style="text-transform: uppercase">Login to
                                                                                                              AccessWorld
                                                                                                              Now!</a>
                            </em>
                        </p>
                        ...
                        your server.<br />
                        <br />
                        For any technical assistance, you can email us at: <a href="mailto:support@accessworld.net">support@accessworld
                                                                                                                    .net.</a><br />
                        <br />
                        </p>
                    </td>
