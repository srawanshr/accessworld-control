@php
    $is_admin = $customer->is_admin ? 'Yes' : 'No';
    $is_subscribed = $customer->is_subscribed ? 'Yes' : 'No';
    $status = $customer->status ? 'Active' : 'Inactive';
@endphp
<div class="card">
    <div class="card-body text-medium">
        <div class="row">
            <div class="col-sm-6">
                <div class="row">
                    ...
                    <div class="col-sm-6">{{ $customer->detail->address ?: '-' }}</div>
                    <div class="col-sm-6 text-bold">Phone:</div>
                    <div class="col-sm-6">{{ $customer->detail->phone ?: '-' }}</div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-6 text-bold">Admin:</div>
                    <div class="col-sm-6">{{ $is_admin }}</div>
