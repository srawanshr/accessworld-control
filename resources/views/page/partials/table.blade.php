<tr>
    ...
    <td class="text-right">
        ...
        <button type="button" data-url="{{ route('page.destroy', $page->slug) }}" class="btn btn-icon-toggle btn-delete" data-toggle="tooltip" data-placement="top" data-original-title="Delete">
